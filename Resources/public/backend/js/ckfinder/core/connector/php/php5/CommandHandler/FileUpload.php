...
// Ajout Egzakt
// Benoit Pruneau - 2011-11-07
require_once($_SERVER['DOCUMENT_ROOT'].'/../vendor/gedmo-doctrine-extensions/lib/Gedmo/Sluggable/Util/Urlizer.php');
...
class CKFinder_Connector_CommandHandler_FileUpload extends CKFinder_Connector_CommandHandler_CommandHandlerBase
{
    ...
    public function sendResponse()
    {
        ...
        // Ajout Egzakt
        // Benoit Pruneau - 2011-11-07
        $sFileName = pathinfo($sFileName);
        $sFileName = Urlizer::urlize($sFileName['filename']) . '.' . $sFileName['extension'];
        // Fin Ajout
