...
function CheckAuthentication()
{
    ...
    // TODO: Fix with Symfony credential
	return true;
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'Egzakt inc';
$config['LicenseKey'] = 'MJHV-NJPY-4GXN-GAFT-3879-MN4Y-2HAS';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => '20M',
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,pps, ppsx,ppppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
		'deniedExtensions' => '');
