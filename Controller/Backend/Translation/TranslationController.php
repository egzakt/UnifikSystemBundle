...
use Unifik\SystemBundle\Entity\LocaleRepository;
use Unifik\SystemBundle\Entity\TokenRepository;
use Unifik\SystemBundle\Entity\Token;
use Unifik\SystemBundle\Entity\TokenTranslation;
use Unifik\SystemBundle\Entity\TokenList;
use Unifik\SystemBundle\Entity\TokenTranslationRepository;
...
class TranslationController extends BaseController
{
    ...
    public function rebuildTokenAction(Request $request)
    {
        ...
        return $this->redirect($this->generateUrl('unifik_system_backend_translation'));
    }
    ...
    public function listAction(Request $request)
    {
        ...
        return $this->render('UnifikSystemBundle:Backend/Translation/Translation:list.html.twig', array(
            'locales' => $locales,
            'tokenList' => $tokenList,
        ));
    }
