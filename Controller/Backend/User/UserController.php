...
use Unifik\SystemBundle\Form\Backend\UserType;
...
class UserController extends BackendController
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('UnifikSystemBundle:Backend/User/User:list.html.twig', array('roles' => $roles));
    }
    ...
    public function editAction($id, Request $request)
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('unifik_system_backend_user_edit', array(
                    'id' => $user->getId()
                )));
            } else {
        ...
        return $this->render('UnifikSystemBundle:Backend/User/User:edit.html.twig', array(
            'user' => $user,
