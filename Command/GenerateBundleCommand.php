...
use Unifik\SystemBundle\Manipulator\RoutingManipulator;
use Unifik\SystemBundle\Generator\BundleGenerator;
...
EOT
            ...
            ->setName('unifik:generate:bundle')
        ;
    }
    ...
    /**
     * The only overloaded part is the Whole directory structure that is now set to true by default
     *
    ...
    /**
     * Create a custom Bundle Generator class
     *
     * @return BundleGenerator
     */
    protected function createGenerator()
    {
        $bundleGenerator = new BundleGenerator($this->getContainer()->get('filesystem'));
        $bundleGenerator->setSkeletonDirs($this->getSkeletonDirs());
