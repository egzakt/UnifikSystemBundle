...
class LoadMappingData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/User/Navigation:GlobalModuleBar');
        $mapping->setType('render');
        ...
        $mapping->setNavigation($manager->merge($this->getReference('navigation-global-module-bar')));
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/Role/Navigation:GlobalModuleBar');
        $mapping->setType('render');
        ...
        $mapping->setNavigation($manager->merge($this->getReference('navigation-global-module-bar')));
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/Locale/Navigation:GlobalModuleBar');
        $mapping->setType('render');
        ...
        $mapping->setNavigation($manager->merge($this->getReference('navigation-global-module-bar')));
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/Application/Navigation:GlobalModuleBar');
        $mapping->setType('render');
        ...
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/Section/Navigation:AppModuleBar');
        $mapping->setType('render');
        ...
        $mapping->setNavigation($manager->merge($this->getReference('navigation-global-module-bar')));
        $mapping->setApp($manager->merge($this->getReference('app-backend')));
        $mapping->setTarget('UnifikSystemBundle:Backend/Translation/Navigation:GlobalModuleBar');
        $mapping->setType('render');
